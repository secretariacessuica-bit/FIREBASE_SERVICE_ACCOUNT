...
class OikosAvatar {
  ...
  const OikosAvatar({
    ...
    this.mouth = MouthType.face01,
    this.hair = HairType.short01,
    this.shirt = ShirtType.basic,
    this.pants = PantsType.pants01,
  ...
  factory OikosAvatar.fromJson(Map<String, dynamic> json) {
    return OikosAvatar(
      ...
      mouth: MouthType.values.firstWhere((e) => e.name == json['mouth'], orElse: () => MouthType.face01),
      ...
      pants: PantsType.values.firstWhere((e) => e.name == json['pants'], orElse: () => PantsType.pants01),
