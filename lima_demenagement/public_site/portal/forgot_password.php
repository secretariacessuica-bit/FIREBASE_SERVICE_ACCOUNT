...
<head>
    ...
    <title>Récupération de mot de passe - LIMA Solutions</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <p>Saisissez votre e-mail pour recevoir les instructions de réinitialisation.</p>
            </div>
            ...
            <form id="form-forgot">
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="email" id="email" class="form-input" placeholder="exemple@domaine.ch" required>
            ...
            <div class="back-to-login">
                <a href="login.php"><i class="fa-solid fa-arrow-left"></i> Retour à la connexion</a>
            </div>
        </div>
    </div>
    ...
    <script>
        document.getElementById('form-forgot').addEventListener('submit', function(e) {
            ...
            btnSubmit.innerHTML = '<div class="spinner"></div><span>Traitement...</span>';
