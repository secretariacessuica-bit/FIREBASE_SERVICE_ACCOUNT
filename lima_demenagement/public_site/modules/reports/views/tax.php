<?php
// LIMA Solutions ERP - Tax / VAT BI View
...
<head>
    ...
    <title>Rapport Fiscalité TVA - LIMA Solutions</title>
    <!-- Google Fonts -->
        ...
        <main class="reports-container" style="padding: 30px; max-width: 1200px; width:100%; margin: 0 auto;">
            ...
            <div class="report-header-section">
                <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:15px; margin-bottom:20px;">
                    <div>
                        <h2 style="font-size:22px; font-weight:700; color:var(--primary-teal-dark);">Rapport Comptable & TVA (Fiscalité Suisse)</h2>
                        <p style="color:var(--text-light); font-size:13px; margin-top:3px;">Synthèse de la TVA collectée par taux d'imposition et périodes.</p>
                    </div>
                    <!-- Export Actions -->
            ...
            <!-- Main Layout with Rates and Period evolution -->
            <div class="charts-grid" style="grid-template-columns: 1fr; margin-bottom: 25px;">
                <div class="report-card">
                    <h4 class="chart-card-title">
                        <i class="fa-solid fa-chart-line" style="color:var(--primary-teal);"></i>
                        Évolution de la TVA Collectée par Période
                    </h4>
                    <div class="chart-wrapper" style="height: 250px;">
                        <canvas id="chart-tax-period"></canvas>
                    </div>
                </div>
            </div>

            <div class="charts-grid" style="align-items: start; gap: 20px;">
                <!-- Table by Tax Rate -->
                <div class="report-card" style="padding: 20px;">
                    <h4 class="chart-card-title" style="margin-bottom: 15px;">
                        <i class="fa-solid fa-percent" style="color:var(--primary-teal);"></i>
                        TVA par Taux d'Imposition (Swiss VAT rates)
                    </h4>
                    <div class="crm-table-wrapper" style="overflow-x:auto;">
                        <table class="crm-table" style="width:100%; border-collapse:collapse; text-align:left;">
                            <thead>
                                <tr style="border-bottom:2px solid var(--border-gray); color:var(--text-light); font-weight:600; font-size:12px;">
                                    <th style="padding:10px;">Taux de Taxe</th>
                                    <th style="padding:10px;">Base HT (Subtotal)</th>
                            ...
                            <tbody id="tax-rates-tbody">
                                <tr>
                                    <td colspan="4" style="text-align: center; color: var(--text-light); padding: 20px;">Chargement...</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="report-card" style="padding: 20px;">
                    <h4 class="chart-card-title" style="margin-bottom: 15px;">
                        <i class="fa-solid fa-calendar-week" style="color:var(--primary-teal);"></i>
                        Consolidation Mensuelle de la TVA
                    </h4>
                    <div class="crm-table-wrapper" style="overflow-x:auto;">
                        <table class="crm-table" style="width:100%; border-collapse:collapse; text-align:left;">
                            <thead>
