<?php
// LIMA Solutions ERP - Cash Flow BI View
...
<head>
    ...
    <title>Flux de Trésorerie - LIMA Solutions</title>
    <!-- Google Fonts -->
        ...
        <main class="reports-container" style="padding: 30px; max-width: 1200px; width:100%; margin: 0 auto;">
            ...
            <div class="report-header-section">
                <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:15px; margin-bottom:20px;">
                    <div>
                        <h2 style="font-size:22px; font-weight:700; color:var(--primary-teal-dark);">Flux de Trésorerie (Cash Flow)</h2>
                        <p style="color:var(--text-light); font-size:13px; margin-top:3px;">Analyse temporelle des entrées nettes et des sorties (extournes).</p>
                    </div>
                    <!-- Export Actions -->
                ...
                <div class="filter-row">
                    ...
                    <div class="filter-group">
                        <label for="filter-group-type">Période d'agrégation</label>
                        <select id="filter-group-type" class="filter-select">
                    ...
                    <table class="crm-table" style="width:100%; border-collapse:collapse; text-align:left;">
                        <thead>
                            <tr style="border-bottom:2px solid var(--border-gray); color:var(--text-light); font-weight:600; font-size:13px;">
                                ...
                                <th style="padding:12px;">Entrées (Cash In)</th>
                                <th style="padding:12px;">Sorties / Reversals (Cash Out)</th>
                                <th style="padding:12px;">Flux Net (Net Cash)</th>
                            </tr>
                        </thead>
