<?php
// LIMA Solutions ERP - Quotes List View
...
<head>
    ...
    <title>Orçamentos / Devis - LIMA Solutions</title>
    <!-- Google Fonts -->
        ...
        <main class="quotes-container">
            <div class="quotes-header-row">
                <div class="quotes-title-section">
                    <h2>Gestion des Orçamentos / Devis</h2>
            ...
            <div class="quotes-card">
                <div style="display: flex; gap: 12px; margin-bottom: 20px;">
                    <div style="position: relative; flex-grow: 1;">
                        ...
                        <input type="text" id="quotes-search-input" class="crm-search-input" placeholder="Rechercher par numéro de devis, client, entreprise, notes...">
                    </div>
                </div>
        ...
        fetch('../../../api/v1/session.php')
            ...
            .then(data => {
                if (data.authenticated) {
                    ...
                    // Dynamic access check for "Nouveau Devis" button
