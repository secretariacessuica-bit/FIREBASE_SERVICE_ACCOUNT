<?php
// LIMA Solutions ERP - CRM Clients List View
...
<head>
    ...
    <title>CRM - Clients - LIMA Solutions</title>
    <!-- Google Fonts -->
        ...
        <main class="crm-container">
            <div class="crm-header-row">
                <div class="crm-title-section">
                    ...
                    <p>Recherchez, modifiez et gérez les fiches clients de votre entreprise.</p>
                </div>
                <!-- Show New Client button if has edit rights -->
            ...
            <div class="crm-card">
                <div class="crm-search-bar">
                    <div class="crm-search-input-wrapper">
                        ...
                        <input type="text" id="crm-search-input" class="crm-search-input" placeholder="Rechercher par nom, code, entreprise, e-mail, téléphone...">
                    </div>
                </div>

                <!-- Clients Dynamic Table -->
        ...
        fetch('../../../api/v1/session.php')
            ...
            .then(data => {
                if (data.authenticated) {
                    ...
                    // Dynamic access check for "Nouveau Client" button
